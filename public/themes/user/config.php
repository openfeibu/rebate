    ...
    'events'  => [
        ...
        'beforeRenderTheme'  => function ($theme) {
            ...
            */
            ...
            $theme->asset()->add('jquery_js', 'js/jquery.min.js');
            $theme->asset()->usePath()->add('index_js', 'js/index.js');
            $theme->asset()->usePath()->add('allen_js', 'js/allen.js');

            $theme->asset()->container('layer_mobile')->add('layer_mobile_layer_css','lib/layer_mobile/need/layer.css');
            $theme->asset()->container('layer_mobile')->add('layer_mobile_layer_js','lib/layer_mobile/layer.js');
        },
