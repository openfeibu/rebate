<input type="hidden" name="{!!$field!!}" id="path" value="@if($files){{$files['path']}}@endif"/>
<div class="layui-input-inline">
    <div class="layui-upload-drag" id="uploadImage">
        <i class="layui-icon layui-icon-upload-drag"></i>
        <p>点击上传，或将文件拖拽到此处</p>
        @if($files)
            <img id="image" src="{!!url("/image/sm".$files['path'])!!}" style="position:absolute;height:120px;width:100%;left:0px;top: 0px;">
        @else
